...
func etcdoperator_v0_9_2(channel string, addSkipsReplaces, addExtraProperties bool) *api.Bundle {
	...
	if addExtraProperties {
		b.Properties = append(b.Properties, []*api.Property{
			...
			{Type: "olm.bundle.object", Value: `{"ref":"objects/etcdbackups.etcd.database.coreos.com_apiextensions.k8s.io_v1beta1_customresourcedefinition.yaml"}`},
			{Type: "olm.bundle.object", Value: `{"ref":"objects/etcdclusters.etcd.database.coreos.com_apiextensions.k8s.io_v1beta1_customresourcedefinition.yaml"}`},
			{Type: "olm.bundle.object", Value: `{"ref":"objects/etcdoperator.v0.9.2_operators.coreos.com_v1alpha1_clusterserviceversion.yaml"}`},
			{Type: "olm.bundle.object", Value: `{"ref":"objects/etcdrestores.etcd.database.coreos.com_apiextensions.k8s.io_v1beta1_customresourcedefinition.yaml"}`},
